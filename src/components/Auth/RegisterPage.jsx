      ...
      <div className="mx-auto w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        {!sharedCloudEnabled && (
          <p className="mb-4 rounded-lg border border-amber-300 bg-amber-50 p-3 text-amber-700 text-sm">
            Hozir app local rejimda ishlayapti. GitHubga joylanganda ro'yxatdan o'tgan userlar
            faqat o'z browserida saqlanadi; Big Admin hammasini ko'rishi uchun `.env` ga
            `VITE_SHARED_API_BASE_URL` qo'shish kerak.
          </p>
        )}
        {freezeReason && (
          <p className="mb-4 rounded-lg border border-amber-300 bg-amber-50 p-3 text-amber-700 text-sm">
